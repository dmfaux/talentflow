  ...
  return (
    <div>
      ...
      <div className="mb-6 flex items-center justify-between">
        ...
        <Link
          href="/clients/new"
          className="inline-flex h-9 items-center gap-1.5 rounded-lg bg-charcoal px-4 text-[0.8rem] font-medium text-cream transition-colors hover:bg-charcoal-light"
        >
      ...
      <div className="overflow-hidden rounded-xl border border-border bg-surface">
        <table className="w-full text-left">
          ...
          <tbody className="divide-y divide-border">
            {loading ? (
              <tr>
                <td colSpan={4} className="px-5 py-10 text-center text-sm text-txt-muted">
                  Loading clients...
                </td>
              </tr>
            ) : clients.length === 0 ? (
                ...
                >
                  <td className="px-5 py-3">
                    <Link
                      ...
                      className="block text-sm font-medium text-charcoal group-hover:text-gold"
                    >
                      {client.name}
                    </Link>
                  </td>
